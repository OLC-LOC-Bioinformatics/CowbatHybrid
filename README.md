...
8) Install other things via conda/mamba (you should have the `conda-forge` and `bioconda` channels set up): `mamba install racon bbmap blast ectyper mob_suite clark nanoplot prodigal filtlong porechop sistr_cmd mash unicycler=0.4.4`
